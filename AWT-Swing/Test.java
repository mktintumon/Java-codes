...
public class Test extends Frame implements ActionListener, ItemListener {
	...
	Test(String title) {
		...
		setSize(400, 100); setLocation(100, 100);
		...
		choice = new Choice();
		choice.add("Windows"); 
		choice.add("Linux"); choice.add("Tizen");
		...
		list1.add("C"); list1.add("C++"); 
		list1.add("Java"); list1.add("Python");
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if(ae.getSource() == list1) {
			 items = list1.getSelectedItems(); repaint();
		}
	...
	public void itemStateChanged(ItemEvent ie) {
		if(ie.getSource() == choice) { msg= ""; msg += choice.getSelectedItem(); repaint(); }
		if(ie.getSource() == choice1) {  msg += "  "+ choice1.getSelectedItem(); repaint(); }
		if(ie.getSource() == cb1 ) {
			tf1.getSelectedText();
